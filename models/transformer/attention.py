...
class SelfAttentionModule(nn.Module):
    def __init__(self, hidden_size, num_attention_heads):
        ...
        self.self_attn = MultiHeadSelfAttentionWithRelativePosition(hidden_size, num_attention_heads)
...
class PositionalEncoder(nn.Module):
    ...
    def __init__(self, max_source_positions, hidden_size):
        super().__init__()
        self.position_encoder = nn.Embedding(max_source_positions, hidden_size)
