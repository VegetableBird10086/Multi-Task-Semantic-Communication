...
class VisualBertEmbeddings(nn.Module):
    ...
    def forward(self, text_feature, token_type_ids=None, visual_feats=None, visual_token_type_ids=None):
...
class VBBertModel(BertPreTrainedModel):
    ...
    def forward(self, text_feature, token_type_ids=None, attention_mask=None,
        ...
        embeddings = self.embeddings(text_feature, token_type_ids=token_type_ids,
